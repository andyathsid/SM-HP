                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Layanan
                            ...
                            <div class="table-responsive">
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/service')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        <tr>
                                            <th>Nama Layanan<span class="text-danger">*</span></th>
                                            <td><input name="title" type="text" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>Deksripsi Singkat<span class="text-danger">*</span></th>
                                            <td><textarea name="small_desc" class="form-control"></textarea></td>
                                        </tr>
                                        <tr>
                                            <th>Deksripsi Lengkap<span class="text-danger">*</span></th>
                                            <td><textarea name="detail_desc" class="form-control"></textarea></td>
                                        </tr>
                                        <tr>
                                            <th>Gambar<span class="text-danger">*</span></th>
