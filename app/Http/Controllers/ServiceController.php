...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/service/create')->with('success','Data berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/service/'.$id.'/edit')->with('success','Data berhasil diperbaharui.');
    }
